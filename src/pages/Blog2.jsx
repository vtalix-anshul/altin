...
const Blog2 = ()=>{
    return(<>
        <div className="container px-4 md:px-8 xl:px-16 py-40 flex flex-col gap-12">
            <h5 className="text-center font-semibold text-3xl lg:text-5xl">Indian Ceramic Sanitary Ware: A Perfect Blend of Functionality and Style</h5>
            ...
            <div className="blog__content px-4 flex flex-col gap-5 text-lg">
                ...
                <div className="blog__content__child py-6 flex flex-col gap-4">
                    <h2 className="font-semibold text-2xl">Style That Defines Spaces</h2>
                    <p>In addition to functionality, Indian ceramic sanitary ware stands out for its stunning designs. Manufacturers offer a wide range of styles, from sleek and minimalist to bold and artistic. This versatility allows homeowners, architects, and interior designers to create spaces that reflect their personal taste and vision.</p>
                    <p>Indian sanitary ware is available in a variety of colours, textures, and finishes, allowing customers to choose pieces that perfectly complement their interiors. Whether it&apos;s a contemporary urban apartment or a luxurious villa, Indian sanitary ware adds a touch of sophistication to every space.</p>
                </div>
                <div className="blog__content__child py-6 flex flex-col gap-4">
                    <h2 className="font-semibold text-2xl">Affordability Without Compromising Quality</h2>
                    <p>One of the key reasons Indian ceramic sanitary ware is making waves globally is its affordability. Despite offering high-quality products, Indian manufacturers can keep costs competitive, making these products accessible to a wide range of customers without compromising on excellence.</p>
                </div>
                <div className="blog__content__child py-6 flex flex-col gap-4">
                ...
                <div className="blog__content__child py-6 flex flex-col gap-4">
                    ...
                    <p>Indian ceramic sanitary ware has earned a reputation as a reliable and stylish solution for homes, offices, and commercial spaces worldwide. With exports spanning across continents, India has become a key player in the global sanitary ware market, supplying products to countries in Asia, Africa, Europe, and beyond.</p>
                </div>
                <div className="blog__content__child py-6 flex flex-col gap-4">
                    <h2 className="font-semibold text-2xl">Conclusion</h2>
                    <p>Indian ceramic sanitary ware represents the perfect blend of functionality, style, and affordability. Whether you&apos;re looking to enhance the aesthetics of your bathroom or ensure lasting performance, Indian manufacturers have got you covered. With a commitment to innovation, quality, and sustainability, the Indian ceramic sanitary ware industry continues to redefine global standards.</p>
                </div>
                <div className="blog__footeer">
                    <p>Transform your spaces with the elegance and efficiency of Indian ceramic sanitary ware—where functionality meets style, and every piece tells a story of timeless craftsmanship.</p>
                </div>
            </div>
        </div>
    </>);
